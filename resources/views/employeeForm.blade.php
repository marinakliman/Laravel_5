...
<body>
    <form name="employeeForm1" method="post" action="{{ url('store-form') }}">
        @csrf
        <div class="userForm">
    ...
    <form name="employeeForm2" method="post" action="{{ url('store-form-json') }}">
        @csrf
        <div class="userForm">
            <div class="userForm__item">
                <label for="workData">Work JSON data</label>
                <textarea type="text" name="workData" id="workData" required="true"></textarea>
            </div>
            <button type="submit" class="userForm__button">Submit</button>
        </div>
    </form>
